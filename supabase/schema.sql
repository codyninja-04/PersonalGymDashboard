...
-- All tables are user-scoped via auth.uid() with Row Level Security.
...
create table if not exists public.profiles (
  ...
  phase text not null default 'Aggressive Cut',
...
-- ============================================================================
-- ROW LEVEL SECURITY — only the owner can read/write their rows
-- ============================================================================
...
-- Generic owner policies for all per-user data tables
do $$
declare
  t text;
begin
  foreach t in array array['weight_logs','bf_logs','personal_records','workout_sessions','daily_fuel'] loop
